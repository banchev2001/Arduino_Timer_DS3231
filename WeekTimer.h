...
public:
	...
	void SetWeekPlanStr(char* WeekPlanStr); //Set week plan as a string like this "SS--WTM"
	...
	void ValOnTime(int8_t Hr, int8_t Min);  // Validate time On Time
	void ValOffTime(int8_t Hr, int8_t Min); // Validate Off Time
